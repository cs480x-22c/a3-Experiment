...
function drawBubbleChart(nums, mark1, mark2) {
    ...
    svg.append("g")
        .attr("transform", "translate(" + centered + "," + (height - 100) + ")");

    svg.append("g")
        .attr("transform", "translate(" + centered + ",0)");
...
function drawBarChart(nums, mark1, mark2) {
    ...
    svg.append("circle")
        .attr("cx", function () {
            return xVals[mark1] + (rectWidth/2) + centered;
        })
        .attr("cy", height - 105)
        .attr("r", 3)
        .style("stroke-width", 2);
    ...
    svg.append("circle")
        .attr("cx", function () {
            return xVals[mark2] + (rectWidth/2) + centered;
        })
        .attr("cy", height - 105)
        .attr("r", 3)
        .style("stroke-width", 2);
